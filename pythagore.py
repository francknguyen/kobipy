...
class Pythagore(Scene):
    def construct(self):
        ...
        enonce = Text("Enoncé du théorème").scale(0.75).shift(3*UP + 3.5*LEFT)
        self.add(titre)
        self.wait(1)
        self.play(
        ...
        demonstration = Text("Démonstration").scale(1)
        ...
        self.play(
            FadeIn(VGroup(brace_a1, a1_legend), shift=UP),
            FadeIn(VGroup(brace_b1, b1_legend), shift=DOWN)
        )
        self.wait(0.5)
        ...
        self.play(
            ReplacementTransform(VGroup(brace_a1, brace_b1), VGroup(brace_ab)),
            ReplacementTransform(VGroup(a1_legend, b1_legend), VGroup(ab_legend)), 
            run_time=2
        )
        self.wait(1)
